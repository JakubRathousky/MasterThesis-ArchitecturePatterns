...
using ResSys.ReservationSystem.Notify;
...
namespace ResSys.ReservationSystem.Service
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddMongo()
                    .AddReservationMongoRepository("reservation")
                    .AddReservationNotifier()
                .AddMassTransitWithRabbitMQ();

            // Add services to DI
            services.AddServiceReservationDI();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ResSys.Reservation", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ResSys.Reservation v1"));
            }
